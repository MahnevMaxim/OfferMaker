        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastChangePriceDate = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: new DateTime(2022, 1, 16, 13, 50, 26, 622, DateTimeKind.Utc).AddTicks(2688)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 16, 13, 50, 26, 626, DateTimeKind.Utc).AddTicks(7651)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfferCreatorId = table.Column<int>(type: "int", nullable: false),
                    ManagerId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 1, 16, 13, 50, 26, 629, DateTimeKind.Utc).AddTicks(4665)),
                    Customer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OfferGroups = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfferInfoBlocks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsHiddenTextNds = table.Column<bool>(type: "bit", nullable: false),
