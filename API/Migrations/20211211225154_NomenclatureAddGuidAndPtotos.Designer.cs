...
namespace API.Migrations
{
    ...
    [Migration("20211211225154_NomenclatureAddGuidAndPtotos")]
    partial class NomenclatureAddGuidAndPtotos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.NomImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shared.Nomenclature", b =>
                {
                    ...
                    b.Property<DateTime?>("LastChangePriceDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 11, 22, 51, 53, 9, DateTimeKind.Utc).AddTicks(7858));
            ...
            modelBuilder.Entity("Shared.Offer", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 11, 22, 51, 53, 19, DateTimeKind.Utc).AddTicks(8236));
            ...
            modelBuilder.Entity("Shared.NomImage", b =>
                {
                    b.HasOne("Shared.Nomenclature", null)
                        .WithMany("Photos")
