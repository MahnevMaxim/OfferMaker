...
namespace ApiLib
{
    ...
    public partial class Nomenclature
    {
        ...
        [Newtonsoft.Json.JsonProperty("lastChangePriceDate", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? LastChangePriceDate { get; set; }

        [Newtonsoft.Json.JsonProperty("actualPricePeriod", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int ActualPricePeriod { get; set; }

        [Newtonsoft.Json.JsonProperty("isPriceActual", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
